...
/**
 * THORSwap Token, THOR
 * Fixed supply: 500m $THOR
 * ERC20, ERC20Permit, Compound-Like Vote
 */
contract ThorToken is ERC20, ERC20Permit, Ownable {
    struct Checkpoint {
        uint32 fromBlock;
        uint224 votes;
    }
    ...
    function delegateBySig(
        ...
        require(nonce == _useNonce(signer), "ThorToken: invalid nonce");
