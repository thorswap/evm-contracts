...
describe("TSWrapperTCRouterV4_V1", function () {
  let tsWrapperTCRouterV4: {
    ...
    connect: (arg0: any) => {
      (): any; new(): any;
      cfReceive: {
        (arg0: number, arg1: any, arg2: any, arg3: any, arg4: any, arg5: { value: any; }): any;
        new(): any;
      };
      wrapDeposit: {
        (arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg6: { value: any; }): any;
        new(): any;
      };
      setRevToken: {
  ...
  before(async function () {
    ...
    tsWrapperTCRouterV4 = await ethers.deployContract("TSWrapperTCRouterV4_V1", ["0xf892fef9da200d9e84c9b0647ecff0f34633abe8"]);
  ...
  it("should correctly wrap deposit and take fee", async function () {
    ...
    const tx = await tsWrapperTCRouterV4.connect(addr1).wrapDeposit(
      vault,
      usdc,
      "100000000",
      memo,
